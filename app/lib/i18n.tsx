...
export const MESSAGES = {
  en: {
    ...
    mapUnavailable: "The map needs WebGL, which isn't available on this device or browser. The results table below still works.",
  ...
  de: {
    ...
    mapUnavailable: 'Die Karte benötigt WebGL, das auf diesem Gerät oder Browser nicht verfügbar ist. Die Ergebnistabelle unten funktioniert weiterhin.',
